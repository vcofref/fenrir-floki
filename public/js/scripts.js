(function ($) {
    "use strict"; console.clear(); gsap.registerPlugin(DrawSVGPlugin, ScrollTrigger, CSSRulePlugin, ScrollToPlugin, MorphSVGPlugin, CustomEase, InertiaPlugin); var pageSet, pageCursor, siteLoader, headerStick, smoothScroll, siteHeader, locoScroll, pageLayout, headerLayout, footerLayout, menuLayout, menuStyle; function pageSettings() {
        pageSet = $('body'); pageCursor = pageSet.data('cursor'); siteLoader = pageSet.data('page-loader'); headerStick = pageSet.data('header-sticky'); smoothScroll = pageSet.data('smoothScroll'); menuStyle = pageSet.data('menu-style'); pageLayout = pageSet.data('page-layout'); headerLayout = pageSet.data('header-layout'); menuLayout = pageSet.data('menu-layout'); footerLayout = pageSet.data('footer-layout'); pageSet.addClass(pageLayout)
            ...
            if (showcaseScroll) {
                ...
                var sitkcyHdr = ScrollTrigger.create({
                    trigger: siteHeader, start: stickyStart + 'bottom', id: 'stickyHeader', markers: false, onLeaveBack: function () {
                        ...
                        gsap.to(headerWrapper, { top: '60%', delay: .5, duration: .75, ease: 'power2.out' })
                    }, onEnter: function () {
                    ...
                    trigger: 'body', start: 'top+=500 top', end: 'bottom bottom', id: 'stickyHeader', markers: false, onEnter: function () {
                        ...
                        ScrollTrigger.create({
                            trigger: 'body', markers: false, start: 'top top', end: 'bottom bottom', onUpdate: function (self, direction, progress) { if (self.direction == -1) { gsap.to(siteHeader, { y: '0%', }) } else { gsap.to(siteHeader, { y: '-100%', }) } }, onLeaveBack: function (self) {
                                self.kill(); gsap.to(siteHeader, { position: 'absolute', y: '0%', height: 150, duration: .75, backgroundColor: 'transparent', delay: .5, clearProps: 'all', ease: 'power2.out' })
    ...
    function aliothProductsCarousel() {
        var apCarousel = $('.alioth-products-carousel'); apCarousel.each(function () {
            ...
            InertiaPlugin.track(apWrapper, "x"); var apcDrag = Draggable.create(apWrapper, { type: "x", bounds: $this, autoScroll: true, inertia: true, edgeResistance: 0.75, dragResistance: 0.4, throwProps: true, }); if (willAnim == true) {
                gsap.fromTo(apWrapper, { x: -5100 }, { x: '0%', duration: 2, ease: 'power2.inOut', scrollTrigger: { trigger: $this, } })
    ...
    function aliothAwards() {
        ...
        awards.each(function () {
            let $this = $(this), award = $this.find('.a-award'), willAnim = $this.data('anim'); if (willAnim == true) {
                award.each(function () {
                    let $this = $(this), title = $this.find('.award-title'), loc = $this.find('.award-loc'), date = $this.find('.award-date'); title.wrapInner('<span></span>')
    ...
    function aliothServicesS2() {
        if ($('.alioth-services').length) {
            ...
            service.on('click', function () {
                let $this = $(this), content = $this.children('.service-wrap'), contentInner = content.children('.service-cont'), contHeight = $this.data('height'); if ($this.hasClass('active')) {
                    $this.removeClass('active'); gsap.to(content, .3, { height: 0, ease: 'power2.Out', delay: .3 })
    ...
    function aliothScrollableText() { var scText = $('.scrollable-text'); scText.each(function () { let $this = $(this); gsap.fromTo($this, { x: '75%' }, { x: '-75%', scrollTrigger: { trigger: $this, scrub: 2, start: 'top bottom', end: 'bottom top', } }) }) }
    ...
    barba.init({
        debug: true, cacheIgnore: true, transitions: [{
            ...
            }, enter() { return new Promise(function (resolve, reject) { gsap.to('.trans-image', { height: '100vh', duration: 1, ease: 'power2.out', onComplete: function () { resolve(); $('.trans-image').remove(); } }) }) }
        }, {
            name: 'fs-image-trans-half', from: { namespace: ['fs-slider'] }, to: { namespace: ['pph1'] }, leave() {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    gsap.to('.trans-image', { height: projHeg, duration: 1.5, delay: 1, ease: 'power2.inOut', onStart: function () { gsap.set('#page', { visibility: 'hidden' }) }, onComplete: function () { $('.trans-image').remove(); resolve(); gsap.set('#page', { visibility: 'visible' }) } })
                })
            }
        }, {
            ...
            }, enter() { return new Promise(function (resolve, reject) { gsap.to('.trans-image', { height: '100vh', duration: 1, ease: 'power2.out', onComplete: function () { resolve(); $('.trans-image').remove(); $('body').removeClass('loading'); } }) }) }
        }, {
